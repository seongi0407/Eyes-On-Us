...
## 🖥️ 프로젝트 소개
<span>
  ‘Eyes On Us’는 협업을 강화하고 일상적인 업무를 효율적으로 관리할 수 있는 그룹웨어를 개발하는 프로젝트입니다.
...
## 🕛 개발 기간
2024.06.11 ~ 2024.07.19
<br>
<br>
<br>

## 🖼️ DB 설계
<img src='https://github.com/user-attachments/assets/3d7062b6-71ec-4e1a-ae1e-d139a3e69efe' width=750px height=500px>
<br>
<br>
<br>
...
<h5>
  휴가, 출장, 기안 목록을 한 눈에 확인할 수 있음<br>
  결재파일에 직접 사인하고, 다운로드 후 재업로드를 통해 직관적인 결재 기능 구현
</h5>
...
<h5>프로젝트를 관리하는 PM과 프로젝트를 담당하는 담당자들이 권한에 따라 프로젝트를 쉽게 관리할 수 있도록 구현</h5>
...
## ⭐ 주요 기능
<h4>1. 결재 관리</h4>
<span>기안자, 결재자, 참조자별로 결재 목록 조회</span> <br />
<span>해당 순서의 결재자는 결재파일을 열람 및 수정을 통해 결재 진행</span> <br />

<br>

<h4>2. 휴가 관리</h4>
<span>신청자, 승인자별로 휴가 목록 조회</span> <br />
<span>승인자는 휴가를 상세 조회하여 승인 및 반려 가능</span> <br />

<br>

<h4>3. 출장 관리</h4>
<span>신청자, 승인자별로 출장 목록 조회</span> <br />
<span>승인자는 출장을 상세 조회하여 승인 및 반려 가능</span> <br />

<br>

<h4>4. KPI (성과지표)</h4>
<span>자신이 맡은 프로젝트에 목표 설정, 집중도 % 로 한눈에 확인 가능</span> <br />

<br>

<h4>5. 평가</h4>
<span>항목별로 별점 부과. 서술식의 평가 작성 가능</span> <br />
<span>팀장은 팀원 평가 진행</span> <br />
<span>팀원은 팀장 및 동료 평가 진행</span> <br />

<br>

<h4>6. 일정 관리</h4>
<span>프로젝트 일정, 기타 일정 (팀, 개인 일정)을 캘린더를 통해 팀원들과 공유</span> <br />

<br>

<h4>7. 프로젝트 관리</h4>
<span>해당 팀의 프로젝트 등록/수정을 통해 관리</span> <br />
<span>프로젝트 담당자 및 회의록 등을 관리</span> <br />

<br>

<h4>8. 사원 관리</h4>
<span>인사 계정으로 사원 관리</span> <br />
<span>퇴사 처리, 직급 변경, 부서 변경, 팀 변경 등 수정 가능</span> <br />

<br>

<h4>9. 팀과 부서 관리</h4>
<span>인사 계정으로 팀과 부서 관리</span> <br />
<span>팀과 부서 등록/수정/삭제 가능</span> <br />
...
1. 로그인 페이지 <br />
<img src='https://github.com/user-attachments/assets/2fe3105f-9e0e-4bd7-81de-02f96100d369' width=750px height=500px>
...
3. 팀 룸 페이지 <br />
<img src='https://github.com/user-attachments/assets/102a60c1-3cb3-4845-9042-8b97b3768f95' width=750px height=500px>
...
11. 사원 관리 <br />
<img src='https://github.com/user-attachments/assets/412c4dd3-6568-43cd-a231-30d0498c0150' width=750px height=500px>
...
13. 일정 관리 <br />
<img src='https://github.com/user-attachments/assets/89fc81ac-f689-43c9-a436-ee0ca998f482' width=750px height=500px>
